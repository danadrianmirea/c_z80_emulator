...
uint8_t sdl_scancode_to_zx_key(uint8_t scancode) {
  ...
  static const uint8_t keymap[] = {
    ...
    [SDL_SCANCODE_LSHIFT] = 0x27,
    [SDL_SCANCODE_RSHIFT] = 0x28,
    [SDL_SCANCODE_CAPSLOCK] = 0x29,
    [SDL_SCANCODE_TAB] = 0x2A
  };
...
uint8_t zx_key_to_row(uint8_t key_value) {
  static const uint8_t rowmap[] = {
    ...
    [0x05] = 0x04,[0x06] = 0x05,[0x07] = 0x06,[0x08] = 0x07,
    [0x09] = 0x08,[0x0A] = 0x09,[0x0B] = 0x0A,[0x0C] = 0x0B,
    [0x0D] = 0x0C,[0x0E] = 0x0D,[0x0F] = 0x0E,[0x10] = 0x0F,
    [0x11] = 0x10,[0x12] = 0x11,[0x13] = 0x12,[0x14] = 0x13,
    [0x15] = 0x14,[0x16] = 0x15,[0x17] = 0x16,[0x18] = 0x17,
    [0x19] = 0x18,[0x1A] = 0x19,[0x1B] = 0x1A,[0x1C] = 0x1B,
    [0x1D] = 0x1C,[0x1E] = 0x1D,[0x1F] = 0x1E,[0x20] = 0x1F,
    [0x21] = 0x20,[0x22] = 0x21,[0x23] = 0x22,[0x24] = 0x23,
    [0x25] = 0x24,[0x26] = 0x25,[0x27] = 0x26,[0x28] = 0x27,
    [0x29] = 0x28,[0x2A] = 0x29
  };
